...
const Login = () => {
    ...
    useEffect(() => {
        // khi mà người dùng thay đổi loginData email, password khi không còn lỗi nữa thì gở bỏ validateForm
        if (isSubmmited) {
            validateForm();
        }
    }, [loginData]);
    ...
    const validateForm = () => {
        ...
        if (loginData.email === '' || loginData.email === undefined) {
            ...
            // nếu valid không thoả - thì sẽ !valid
            if (!valid) {
        ...
        // kiểm tra độ dài của errors object nếu lớn hơn 0 đang có lỗi
                                        ...
                                        <form>
                                            <div className='form-floating mb-3'>
                                                <input
                                                    ...
                                                    type='email'
                                                    name='email' // thêm này để e.target.name bắt được value email
                                                    onChange={onChange}
